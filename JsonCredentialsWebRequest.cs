...
////////////////////////////////////////////////////////////////////////////
    ...
    public class JsonCredentialsWebRequest
    {
        ...
        public JsonCredentialsWebRequest(string UserName, string Password, string Domain = null)
        {
            userName = UserName;
            password = Password;
            domain = Domain;
        ...
        /// <param name="Password">Domain user name Password</param>
        ///
        public JsonCredentialsWebRequest(string UserName, string Password)
        {
            userName = UserName;
            password = Password;
        ...
        public JsonCredentialsWebRequest()
        {
        ...
        public string RepeatRequest(string url, int counter = 2, int deltaTime = 20000)
        {
            bool repeat = true;
            int CountWait = 0;
            String ret = ""; ;
